test: test.o fonctions.o libisentlib.a
	gcc -Wall test.o fonctions.o -o test libisentlib.a -lm -lglut -lGL -lX11
...
test.o: test.c GfxLib.h BmpLib.h ESLib.h fonctions.h
	gcc -Wall -c test.c 

fonctions.o: test.c GfxLib.h BmpLib.h ESLib.h fonctions.h
